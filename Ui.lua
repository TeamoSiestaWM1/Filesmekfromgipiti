--[[
    ...
    - FARM RARE: TỰ ĐỘNG DI CHUYỂN THEO DANH SÁCH VỊ TRÍ
    ================================================================================
]]
...
-- [[ UI CHECK BLENDER ]]
local bFrame = Instance.new("Frame", col3); bFrame.Size = UDim2.new(1, -20, 0, 150); bFrame.Position = UDim2.new(0, 10, 0, 480); bFrame.BackgroundColor3 = Color3.fromRGB(10, 10, 10); Instance.new("UICorner", bFrame)
...
local function TweenTo(cf)
    ...
    root.Anchored = true
    local tw = TweenService:Create(root, TweenInfo.new(dist/100, Enum.EasingStyle.Linear), {CFrame = cf})
    tw:Play(); tw.Completed:Wait(); root.Anchored = false
end
...
local function BuildControlBtn(text, y, color, func)
    local b = Instance.new("TextButton", col3); b.Size = UDim2.new(1, -20, 0, 50); b.Position = UDim2.new(0, 10, 0, y); b.Text = text; b.TextSize = 22; b.BackgroundColor3 = color; b.TextColor3 = Color3.new(1, 1, 1); Instance.new("UICorner", b); b.MouseButton1Click:Connect(func); return b
end

local rareBtn = BuildControlBtn("START RARE", 185, Color3.fromRGB(75, 0, 130), function() end)
rareBtn.MouseButton1Click:Connect(function()
    farmrare = not farmrare
    rareBtn.Text = farmrare and "STOP RARE" or "START RARE"
    rareBtn.BackgroundColor3 = farmrare and Color3.fromRGB(200, 0, 0) or Color3.fromRGB(75, 0, 130)
end)

BuildControlBtn("STOP BLENDER", 245, Color3.fromRGB(150, 0, 0), function() ReplicatedStorage.Events.BlenderCommand:InvokeServer("StopOrder") end)
BuildControlBtn("FINISH BY TICKETS", 305, Color3.fromRGB(0, 120, 0), function() ReplicatedStorage.Events.BlenderCommand:InvokeServer("SpeedUpOrder") end)
BuildControlBtn("FEED ALL BEES", 365, Color3.fromRGB(255, 140, 0), function()
...
BuildControlBtn("STOP FEEDING", 425, Color3.fromRGB(180, 50, 50), function() feeding = false end)
